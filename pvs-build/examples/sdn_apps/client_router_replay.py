...
FORWARD = 1
# ip_dst => "00:15:4d:13:61:07 0b00000100"
forward_table_dict = {}
    ...
    while True:
		...
		# The packet can be either ipv4 or 802.1q (vlan).
                if ether_type == 2048 or ether_type == 33024:
                    ...
                    client.WriteTableEntry(p4runtime_pb2.Update.INSERT, IPV4_NHOP, ip_dst, ip_dst)
                    client.WriteTableEntry(p4runtime_pb2.Update.INSERT, FORWARD, ip_dst, "00:15:4d:13:61:07 0b00000100")
