...
import org.onosproject.p4runtime.ctl.client.WriteRequestImpl;
import org.slf4j.Logger;
import p4.v1.P4RuntimeOuterClass;
import p4.v1.P4RuntimeOuterClass.StreamMessageRequest;
import p4.v1.P4RuntimeOuterClass.StreamMessageResponse;
import org.onosproject.p4runtime.ctl.controller.AuthOuterClass;
...
public final class StreamClientImpl implements P4RuntimeStreamClient {
    ...
    public boolean isSessionOpen(long p4DeviceId) {
        ...
        //sendAuthRequest();
        //streamChannelManager.send(StreamMessageRequest.newBuilder()
         //       .build());
    ...
    public AuthOuterClass.Auth createAuthMessage(){
        return new AuthOuterClass.Auth.Builder()
                .setPasswd("admin")
                .setUserName("admin")
                .build();
    }
    private void sendAuthRequest() {
        log.warn("Sending authentication Credentials");
        streamChannelManager.send(
                StreamMessageRequest.newBuilder()
                        .setOther(Any.pack(createAuthMessage()))
                        .build()
        );
    }
